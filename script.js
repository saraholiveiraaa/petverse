...
function mobileLayout() {
  // ativa as clases headerBottom e active quando o tamanho da tela for menor que 900px (desktop)
...
// verifica se a página está maior que 900px e chama a função mobileLayout()
